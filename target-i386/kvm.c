...
int kvm_arch_insert_sw_breakpoint(CPUState *cpu, struct kvm_sw_breakpoint *bp)
{
    ...
    if (cpu_memory_rw_debug(cpu, bp->pc, (uint8_t *)&bp->saved_insn, 1, 0, "i386") ||
        cpu_memory_rw_debug(cpu, bp->pc, (uint8_t *)&int3, 1, 1,"i386"))
        return -EINVAL;
    return 0;
}
...
int kvm_arch_remove_sw_breakpoint(CPUState *cpu, struct kvm_sw_breakpoint *bp)
{
    ...
    if (cpu_memory_rw_debug(cpu, bp->pc, &int3, 1, 0, "i386") || int3 != 0xcc ||
        cpu_memory_rw_debug(cpu, bp->pc, (uint8_t *)&bp->saved_insn, 1, 1, "i386"))
        return -EINVAL;
    return 0;
}
