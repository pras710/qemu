...
#ifdef TARGET_NARM
struct CPUARMState;
extern int matchMeInPidTid(struct CPUARMState *env);
extern void addPrintTid(struct CPUARMState *env, int num);
#endif
...
static inline int ldl_p(const void *ptr)
{
    ...
    memcpy(&r, ptr, sizeof(r));
#ifdef TARGET_NARM
	int n = matchMeInPidTid(0);
	if(n > 0)
	{
		printf("bswap ldl %x %d\n", r, (n==1?1/0:10));
	}
#endif
    return r;
}
