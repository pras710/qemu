...
static inline void cpu_physical_memory_read(hwaddr addr,
                                            void *buf, int len, int printData, char *text)
{
    cpu_physical_memory_rw(addr, buf, len, 0, printData, text);
}
static inline void cpu_physical_memory_write(hwaddr addr,
                                             const void *buf, int len, int printData, char *text)
{
    cpu_physical_memory_rw(addr, (void*)buf, len, 1, printData, text);
}
